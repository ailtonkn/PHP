...
<body>
	...
	<h3>
		Faça um programa que receba o salário e o tempo (em anos) de serviço de um 
		funcionário. Com base no valor do salário e no tempo e serviço, mostre qual será o 
		valor da gratificação que esse funcionário receberá
	</h3>
	...
	<form action="ex3.php" method="post">
		...
		<p>
			...
			<input type="number" name="salario" min="800" step="0.01" required class="inputs">
		</p>
	...
	if (isset($_POST['enviar'])) 
	{
		...
		echo "<p>Osalário do funcionário é R\$ $salario, ele trabalha há $tempo ano(s) na empresa, portanto, seu bõnus será de R\$ $bonus</p>";
