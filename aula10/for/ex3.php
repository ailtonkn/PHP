...
<body>
	...
	<h4>
		Somar todos os valores pares entre 34 e 87. Ao final, mostrar a soma, a quantidade de valores pares encontrados
		e a média destes valores.
	</h4>
	...
	for ($cont = 34; $cont <= 87; $cont++)
	{
		if ($cont % 2 == 0)
		{
			$qtde++; // incremento a quantidade de valores pare encontrados
			// somo o valor de $soma com o valor atual de $cont:
			$soma += $cont; // mesma coisa que: $soma + $cont; 
