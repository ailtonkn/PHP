...
<body>
	...
	for ($cont = 1; $cont <= 100; $cont++)
	{
		...
		{
			$pares++;
			$soma_pares += $cont; // $somma_pares = $soma_pares + $cont
		}
		else
		{
			$impares++;
	...
	echo "A quantidade de valores pares: $pares<br>";
	echo "A soma dos valores pares: $soma_pares<br>";
	echo "A média dos valores ímpares: $media";
